...
load each file, listen for changes to _suman.projectRoot, either reading or writing
if it's read or wrote to, we cannot load the file.
...
process.once('message', function (data) {
  ...
  if (data.msg.cwd) {
    console.log(' => changing cwd to', data.msg.cwd);
